						...
						while($services_query->have_posts()) :
							...
							<li>
								<div class="inner constructify_tm_minibox">
									...
									<?php the_excerpt(); ?>
									<a href="<?php the_permalink() ?>" class="arrow"><?php echo esc_html__( 'READ MORE', 'density-business' ); ?></a>
									<span class="shape">
										<i class="<?php echo esc_attr($services_icons[$count]); ?> svg" aria-hidden="true" aria-hidden="true"></i>
									</span>
